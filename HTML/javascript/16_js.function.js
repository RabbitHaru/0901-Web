...
// 매개 변수 : 하나의 함수를 여러 번 샐행할 수 있도록 실행할 때마다 바뀌는 값을변수로 처리한 것
// 인수 : 함수를 실행할 때 매개 변수 자리에 넘겨주는 값
// return 문 함수가 종료할 때 반환 하는값
...
// 매기 변수에 기본값 지정하기 ( 기본값을 지정할 때는 마지막 매개변수부터 지정한다. )
...
// 3. 기본 화살표 함수 명령문에 return문 하나만 있으면 생략가능
let numSum3 = (a, b) => a + b;