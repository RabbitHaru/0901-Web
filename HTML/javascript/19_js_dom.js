// 문서객체모델(DOM) : 문서에 있는 HTML 요소를 객체로 받아와서 사용할 수 있다.
...
// innerHTML : 보이는 것과 상관없이 HTML 태그를 포함하여 텍스트 내용을 접근한다.
...
//  실습 1. 체크를 크릭하면 체크와 텍스트에 중간 줄 긋기
