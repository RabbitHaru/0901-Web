  ...
  return (
    <div className="container bg-white">
      ...
      <form action="/articles" method="get">
        <input type="hidden" name="size" defaultValue="${pageRequestDTO.size}" />
        <div className="mb-3">
          ...
          <input type="text" name="keyword" defaultValue="${pageRequestDTO.keyword}" />
          <input type="submit" defaultValue="검색" />
        </div>
      </form>
      {articleList.map((item) => (
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <Link
              to={"/article/"+item.id} className="btn btn-primary"
            >
              보러가기
            </Link>
          </div>
