                ...
                <div class="card-body">
                    ...
                    <form action="/todo/list" method="get">
                        ...
                        <div class="input-group mb-3 dueDateDiv">
                            <input type="date" name="from" class="form-control" value="${pageRequest.DTO.from}">
                            <input type="date" name="to" class="form-control" value="${pageRequest.DTO.to}">
                        </div>
                        ...
                        <ul class="pagination flex-wrap">
                            ...
                            <c:forEach begin="${responseDTO.start}"
                                ...
                                <li class="page-item ${responseDTO.page == num?"active":""}">
                                    <a class="page-link" date-num="${num}">${num}</a>
                                </li>
                            </c:forEach>
