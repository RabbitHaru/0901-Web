...
// 추상클래스는 추상메서드가 포함되어있기 때문에 직접 인스턴스화 하는것은 불가능함
// 반드시 상속하여 자식클래스 만들고 인스턴스화 해야함.
abstract class Unit {
	String name;
	int hp;
...
public class MyStarcraft {
	...
	public static void main(String[] args) {
		...
		Marine unit1 = new Marine("마린",100);
		unit1.doMove();
		unit1.printUnit();

		Zergling unit2 = new Zergling("저글링",1);
		unit2.doMove();
		unit2.printUnit();
//		추상클래스는 인스턴스화 할 수 없기 때문에 에러 발생
//		Unit unit3 = new Unit();
//		unit3.doMove();
	}
