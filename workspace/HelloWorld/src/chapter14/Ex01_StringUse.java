...
public class Ex01_StringUse {
	...
	public static void main(String[] args) {
		...
		String str1 = new String("제노프로그래밍");
		String str2 = new String("제노프로그래밍");
		String str3 = "자바프로그래밍";
		String str4 = "자바프로그래밍";
		
		// == : 객체를 비교할 경우 메모리주소를 확인하는 연산자
		if(str1 == str2) {
		System.out.println("st1과 str2는 동일한 객체 참조");
		} else {
		System.out.println("st1과 str2는 다른 객체 참조");
		}
		if(str3 == str4) {
		System.out.println("st3과 str4는 동일한 객체 참조");
		} else {
		System.out.println("st3과 str4는 다른 객체 참조");
		}
		
//		equals() : String안의 문자열을 비교하는 메서드
		if(str1.equals(str2)) {
			System.out.println("st1과 str2는 동일한 문자열");
		} else {
			System.out.println("st1과 str2는 다른 문자열");
		}
		if(str3.equals(str4)) {
			System.out.println(".equalsst3과 str4는 동일한 문자열");
		} else {
			System.out.println("st3과 str4는 다른 문자열");
		}
//		대소문자를 구분하지 않고 문자열을 비교하는 메서드
		String str5 = "Apple";
		String str6 = "apple";
		if(str5.equals(str6)) {
			System.out.println(".equals:st3과 str4는 동일한 문자열");
		}
		if(str5.equalsIgnoreCase(str6)) {
			System.out.println("equalsIgnoreCase:str5와 str6은 동일한 문자열");
		}
//		compareTo() : 사전순으로 비교하여 앞에 있으면 음수, 뒤에있으면 양수, 같으면 0
...
//		문자열 자르기
		...
		System.out.println(str.substring(5,10)); // 5번 위치부터 10번 위치까지
		System.out.println(
...
//		251016 : 연월일을 각각 출력해보자
		...
		System.out.println(num.substring(4, 6));
...
//		replace("바뀌기전 문자열","바꾼후 문자열") : 특정 문자열 변경하기 메서드
